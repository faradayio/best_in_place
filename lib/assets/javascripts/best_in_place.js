...
BestInPlaceEditor.prototype = {
    ...
    sanitizeValue: function (s) {
        ...
        // If the string is JSON (starts with { or [), return it unmodified
        if (this.jsonMatcher && this.jsonMatcher.test(s)) {
            return s;
        }
        
        // Otherwise, sanitize the HTML entities
        ...
        return String(s).replace(/[&<>"'`=\/]/g, function fromEntityMap (s1) {
            return entityMap[s1];
        });
    },
